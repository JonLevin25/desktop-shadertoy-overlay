...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  updateConfig: (updates: { opacityPercent?: number; timeScale?: number; frameRate?: number | null; showWindowInTaskbar?: boolean; showSettingsOnWindowFocused?: boolean }) => ipcRenderer.invoke('update-config', updates),
});
...
declare global {
  interface Window {
    electronAPI: {
      ...
      getConfig: () => Promise<{ opacityPercent: number; timeScale: number; frameRate: number | null; showWindowInTaskbar: boolean; showSettingsOnWindowFocused: boolean }>;
      updateConfig: (updates: { opacityPercent?: number; timeScale?: number; frameRate?: number | null; showWindowInTaskbar?: boolean; showSettingsOnWindowFocused?: boolean }) => Promise<{ opacityPercent: number; timeScale: number; frameRate: number | null; showWindowInTaskbar: boolean; showSettingsOnWindowFocused: boolean }>;
    };
  }
}
